...
export async function POST(req: Request) {
  try {
    ...
    const overviewPrompt = `
      Generate an overview for the following project:\n\n
      ...
      Start by describing the project(project desciption-not too long nor too short-make it look good (content)), then mention about the benificiaries , the targeted outcome . Do not mention anything else - follow this strict format
      leave a line space after each of the 4 points.Do not mention project description : or prooject overview and start , start directly with the description. Remember no headings , i want no headings in the response. Do not hgihlight anything , jsut give your response as a single paragraph.`;
